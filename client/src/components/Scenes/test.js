...
export default class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    playerSprite.map((sprite) => {
      ...
      spriteImg.onload = () => {
        this.textures.addSpriteSheet(sprite.name, spriteImg, {
              frameWidth: sprite.frameWidth,
          frameHeight: sprite.frameHeight,
        })
      }
      spriteImg.src = sprite.image;
      // sprite.image.onload = () => {
      //   this.textures.addSpriteSheet(sprite.name, sprite.image, {
      //     frameWidth: sprite.frameWidth,
      //     frameHeight: sprite.frameHeight,
      //   })
      // }
    ...
    fruitSprite.map((fruit) => {
      ...
      // });
      // fruit.image.onload = () => {
      //   this.textures.addSpriteSheet(fruit.name, fruit.image, {
      //     frameWidth: fruit.frameWidth,
      //     frameHeight: fruit.frameHeight,
      //   })
      // }

      let fruitImg = new Image();
      fruitImg.onload = () => {
        this.textures.addSpriteSheet(fruit.name, fruitImg, {
              frameWidth: fruit.frameWidth,
          frameHeight: fruit.frameHeight,
        })
      }
    ...
    hazardSprite.map((hazard) => {
      ...
      // hazard.image.onload = () => {
      //   this.textures.addSpriteSheet(hazard.name, hazard.image, {
      //     frameWidth: hazard.frameWidth,
      //     frameHeight: hazard.frameHeight,
      //   })
      // }
      let hazardImg = new Image();
      hazardImg.onload = () => {
        this.textures.addSpriteSheet(hazard.name, hazardImg, {
              frameWidth: hazard.frameWidth,
          frameHeight: hazard.frameHeight,
        })
      }
      hazardImg.src = hazard.image;
    })
